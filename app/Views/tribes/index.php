...
<h2>Tribos</h2>
<form method="post" action="/tribes/create" class="card">
...
<td><form method="post" action="/tribes/join"><input type="hidden" name="tribe_id" value="<?= (int)$tribe['id'] ?>"><button>Entrar</button></form></td></tr>
<?php endforeach; ?>
</table>
<?php if ($myTribe): ?>
...
<form method="post" action="/tribes/chat"><input name="message" placeholder="Mensagem" required><button>Enviar</button></form>
<?php endif; ?>
